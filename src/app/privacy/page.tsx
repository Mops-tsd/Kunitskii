      ...
      <div className="shell max-w-3xl">
        ...
        <div className="mt-12 space-y-10 text-concrete">
          ...
          <section>
            ...
            {/* TODO (заказчик): подтвердить сервис. В сборке подготовлена
                Яндекс.Метрика — она включается номером счётчика, без
                правки кода. Если выберете другой сервис, здесь нужно
                поменять название и ссылку. */}
            <p className="mt-3 leading-relaxed">
              Статистику собирает сервис «Яндекс.Метрика». Он использует файлы
              cookie и хранит данные на своей стороне на условиях{' '}
              <a
              ...
              . Пока счётчик не подключён, сайт не загружает его код и не
              ставит его файлы cookie.
            </p>
          </section>
