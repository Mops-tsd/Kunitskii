    ...
    steps: [
      {
        ...
        org: '“运输建设开发”集团（ТСД）',
        body:
          '领导投资建设控股集团：在俄罗斯北极地区和远东联邦区开发住宅区、社会设施与市政工程基础设施。',
        source: '集团公开资料',
      },
      {
        period: '2025年起',
        ...
        org: '“ТСД 发展”有限公司，赤塔',
        body:
          '集团外贝加尔方向：赤塔与后贝加尔斯克的住宅项目，包括中俄边境的住宅区。',
        source: '俄罗斯法人统一登记簿',
      },
      {
        period: '2022年起',
        role: '负责人',
        org: '“运输建设开发”专业开发有限公司，符拉迪沃斯托克',
        body:
          '集团远东方向：具备资质的住宅开发商，按共同建设合同并在超前发展区优惠制度下运作。',
        source: '俄罗斯法人统一登记簿',
      },
    ],
    note:
      '以上依据公开来源整理：俄罗斯法人统一登记簿及集团公开资料。教育背景以及加入本集团之前的任职将在核实后补充。',
  },
  ...
  recognition: {
    ...
    items: [
      ...
      },
      {
        source: '区域综合开发',
        title: '住宅与配套设施同步交付',
        body: '项目在建设住宅的同时配套社会、交通与市政基础设施，而非仅建住宅楼。',
      },
      {
        source: '优惠制度',
        title: '超前发展区与北极区',
